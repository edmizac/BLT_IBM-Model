  ...
  ;; BLT ROUTINE
    ...
    if timestep < simulation-time [ ; energy levels: energy_level_1 = 80 and energy_level_2 = 150
      ifelse energy < energy_level_1 [ ; energy < level 1
        ...
        ifelse (action = "feeding" or action = "travel") [   ;; v1 version
...
"" ""
PENS
"default" 1.0 1 -16777216 true "" "let a freq_map behaviorsequence\nlet behav0 item 0 behaviorsequence\nplotxy item 0 behav0 item 1 behav0"
