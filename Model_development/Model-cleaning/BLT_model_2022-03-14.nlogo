...
to setup-trees
  ...
  if ( tree-scenario = "trees_all_1" )   [ set tree-file "../../Data/Shapefiles/trees_all_1.shp" ]   ; for simulated sleeping and resting trees; all trees for the 5 months without rest and sleeping sites (153 days, tree types: 1-9)
  if ( tree-scenario = "trees_all_2" )   [ set tree-file "../../Data/Shapefiles/trees_all_2.shp" ]   ; for real-data sleeping and resting trees; all trees for the 5 months (153 days, tree types: 1-9 = feeding, 10 = resting, 11 = sleeping)
  if ( tree-scenario = "trees_april_1" ) [ set tree-file "../../Data/Shapefiles/trees_april_1.shp" ] ; for April simulation (30 days - tree types: 1,7,9)
  if ( tree-scenario = "trees_may_1" )   [ set tree-file "../../Data/Shapefiles/trees_may_1.shp" ]   ; for May (31 days - tree types: 2,6,7,9)
  if ( tree-scenario = "trees_june_1" )  [ set tree-file "../../Data/Shapefiles/trees_june_1.shp" ]  ; for June (30 days - tree types: 3,6,7,8,9)
  if ( tree-scenario = "trees_july_1" )  [ set tree-file "../../Data/Shapefiles/trees_july_1.shp" ]  ; for July (31 days - tree types: 4,8,9)
  if ( tree-scenario = "trees_aug_1" )   [ set tree-file "../../Data/Shapefiles/trees_aug_1.shp" ]   ; for August (31 days - tree types: 5,8,9)
  ...
  foreach gis:feature-list-of trees-gis [ vector-feature ->
   ...
   ;; load tree-file according to tree-scenario chooser (.csv)
  if ( tree-scenario = "trees_all_1" )   [ set tree-file "../../Data/Trees-Guarei/Data_Guarei_FelipeBufalo_EMZ1_trees_all.csv" ]   ;
  if ( tree-scenario = "trees_may_1" )   [ set tree-file "../../Data/Trees-Guarei/Data_Guarei_FelipeBufalo_EMZ1_trees_may.csv" ]   ;
  if ( tree-scenario = "trees_june_1" )  [ set tree-file "../../Data/Trees-Guarei/Data_Guarei_FelipeBufalo_EMZ1_trees_jun.csv" ]   ;
  if ( tree-scenario = "trees_july_1" )  [ set tree-file "../../Data/Trees-Guarei/Data_Guarei_FelipeBufalo_EMZ1_trees_jul.csv" ]   ;
  if ( tree-scenario = "trees_aug_1" )   [ set tree-file "../../Data/Trees-Guarei/Data_Guarei_FelipeBufalo_EMZ1_trees_aug.csv" ]   ;
