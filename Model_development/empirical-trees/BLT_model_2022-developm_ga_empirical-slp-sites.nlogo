...
to move-monkeys
  ...
  ask monkeys [
    ...
    if timestep = 1 [
      ...
      set energy start-energy            ;; THIS SHOULD BE TAKEN OUT
    ]
...
;      set tree_add_list [] ;; Coutput-day-statsOMMENT OUT THIS BECAUSE THE TAMARINS DON'T FORGET
      output-day-stats
  ]
end
...
to output-day-stats
  ...
  output-type "tree_target"
  output-print tree_target
  output-type "tree_current"
  output-print tree_current
end
