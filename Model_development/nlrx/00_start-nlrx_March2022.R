## Header --------------------------
# Script name: 00_start-nlrx_March2022
# Script purpose: To show the first runs with nlrx that worked
#                  (files on Model_development\Model-cleaning\Previous_2022-03-11)
# Date created: 2022-04-27d
...
modelpath <- here("Model_development", "Model-cleaning", "Previous_2022-03-11", "BLT_model_2022-developm.nlogo")
file.info(modelpath)
...
#### Simple design experiment ( = one run_days button) (old version) ####
...
nl@experiment <- experiment(expname = expname,
                            ...
                            #                  ),
                            variables = list(),
                            constants = list("no_days" = 1,
                                             'feeding-trees-scenario' = "\"trees_all_2\"",
...
#### Read RDS with succeeded run from March 2022 ####

# saveRDS(nl, file = "nl_simple_2022-02-16d.rds")
nl <- readRDS(file = here("Model_development", "Model-cleaning", "Previous_2022-03-11", "nl_simple_2022-02-16d.rds"))
